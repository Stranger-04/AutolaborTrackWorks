...
if("TRUE" STREQUAL "TRUE")
  set(tl740d_SOURCE_PREFIX /opt/autolabor/ros/catkin_ws/src/driver/imu/tl740d)
  set(tl740d_DEVEL_PREFIX /opt/autolabor/ros/catkin_ws/devel/.private/tl740d)
  set(tl740d_INSTALL_PREFIX "")
  set(tl740d_PREFIX ${tl740d_DEVEL_PREFIX})
else()
  set(tl740d_SOURCE_PREFIX "")
  set(tl740d_DEVEL_PREFIX "")
  set(tl740d_INSTALL_PREFIX /opt/autolabor/ros/catkin_ws/install)
...
if(NOT "/opt/autolabor/ros/catkin_ws/src/driver/imu/tl740d/include " STREQUAL " ")
  set(tl740d_INCLUDE_DIRS "")
  set(_include_dirs "/opt/autolabor/ros/catkin_ws/src/driver/imu/tl740d/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl740d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/autolabor/ros/catkin_ws/src/driver/imu/tl740d/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/autolabor/ros/catkin_ws/devel/.private/tl740d/lib;/opt/autolabor/ros/catkin_ws/devel/lib;/opt/ros/melodic/lib)
