...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /opt/autolabor/ros/catkin_ws/src/mapping/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /opt/autolabor/ros/catkin_ws/devel/.private/openslam_gmapping)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /opt/autolabor/ros/catkin_ws/install)
...
if(NOT "/opt/autolabor/ros/catkin_ws/src/mapping/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/opt/autolabor/ros/catkin_ws/src/mapping/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/autolabor/ros/catkin_ws/src/mapping/openslam_gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/autolabor/ros/catkin_ws/devel/.private/openslam_gmapping/lib;/opt/autolabor/ros/catkin_ws/devel/lib;/opt/ros/melodic/lib)
