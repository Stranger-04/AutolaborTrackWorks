...
if("TRUE" STREQUAL "TRUE")
  set(navi_multi_goals_pub_rviz_plugin_SOURCE_PREFIX /opt/autolabor/ros/catkin_ws/src/tool/navi_multi_goals_pub_rviz_plugin)
  set(navi_multi_goals_pub_rviz_plugin_DEVEL_PREFIX /opt/autolabor/ros/catkin_ws/devel/.private/navi_multi_goals_pub_rviz_plugin)
  ...
  set(navi_multi_goals_pub_rviz_plugin_INSTALL_PREFIX /opt/autolabor/ros/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navi_multi_goals_pub_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/autolabor/ros/catkin_ws/src/tool/navi_multi_goals_pub_rviz_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/autolabor/ros/catkin_ws/devel/.private/navi_multi_goals_pub_rviz_plugin/lib;/opt/autolabor/ros/catkin_ws/devel/lib;/opt/ros/melodic/lib)
