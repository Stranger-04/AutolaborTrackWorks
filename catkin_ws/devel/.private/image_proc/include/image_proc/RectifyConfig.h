...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RectifyConfig::AbstractParamDescriptionConstPtr(new RectifyConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum_description': 'interpolation type', 'enum': [{'srcline': 9, 'description': 'Nearest neighbor', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'NN'}, {'srcline': 10, 'description': 'Linear', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Linear'}, {'srcline': 11, 'description': 'Cubic', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Cubic'}, {'srcline': 12, 'description': 'Lanczos4', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Lanczos4'}]}", &RectifyConfig::interpolation)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_NN = 0;
//#line 10 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Linear = 1;
//#line 11 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg"
      const int Rectify_Cubic = 2;
//#line 12 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Rectify.cfg"
