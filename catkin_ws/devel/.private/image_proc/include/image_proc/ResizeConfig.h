...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ResizeConfig::AbstractParamDescriptionConstPtr(new ResizeConfig::ParamDescription<int>("interpolation", "int", 0, "Interpolation algorithm between source image pixels", "{'enum_description': 'interpolation type', 'enum': [{'srcline': 11, 'description': 'Nearest neighbor', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'NN'}, {'srcline': 12, 'description': 'Linear', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Linear'}, {'srcline': 13, 'description': 'Cubic', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Cubic'}, {'srcline': 14, 'description': 'Lanczos4', 'srcfile': '/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Lanczos4'}]}", &ResizeConfig::interpolation)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_NN = 0;
//#line 12 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_Linear = 1;
//#line 13 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg"
      const int Resize_Cubic = 2;
//#line 14 "/opt/autolabor/ros/catkin_ws/src/tool/image_pipeline/image_proc/cfg/Resize.cfg"
