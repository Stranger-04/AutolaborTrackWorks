...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /opt/autolabor/ros/catkin_ws/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /opt/autolabor/ros/catkin_ws/devel/.private/map_server)
  ...
  set(map_server_INSTALL_PREFIX /opt/autolabor/ros/catkin_ws/install)
...
if(NOT "/opt/autolabor/ros/catkin_ws/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/opt/autolabor/ros/catkin_ws/src/navigation/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/autolabor/ros/catkin_ws/src/navigation/map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/autolabor/ros/catkin_ws/devel/.private/map_server/lib;/opt/autolabor/ros/catkin_ws/devel/lib;/opt/ros/melodic/lib)
